...
/* StaticForce3000_1. These are operating-envelope facts, not writable tuning
...
#define FORCE_SERVO_PROFILE_FIELDS(X) \
 X(id,1) X(unit,0) X(qualifications,0) \
 ...
 X(peak_press,0) X(boost_ms,0) X(boost_total_ms,0) X(taper_margin,0) \
