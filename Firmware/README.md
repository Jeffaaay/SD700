...
GitHub main is the source of truth: `git switch main`, `git pull --ff-only`,
`git rev-parse HEAD`, then run this verifier and use the repository files above.
There is no ZIP handoff or package-verification prerequisite.
