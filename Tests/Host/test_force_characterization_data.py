...
class CharacterizationData(unittest.TestCase):
    def test_fixed_envelope_and_gain_schema(self):
        ...
        self.assertEqual((s['schema'],s['build_id'],len(s['u32']),len(s['floats'])),(0xF108,0x4653010A,86,27))
        ...
        self.assertEqual([c[n] for n in ('kp','ki','kd','measurement_filter_s','session_ms','tracking_ms','lease_ms','feedback_gap_ms','sample_age_ms')],[10,0,0,0,5000,5000,130,125,20])
    ...
    def test_session_and_post_assist_measurement_provenance(self):
