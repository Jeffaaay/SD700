# Runtime characterization protocol ? F108 / build4653010A
...
The conservative TIM5 session compare can trip at4999 ms; classification is
SESSION_TIMEOUT only near the absolute deadline with still-recent pressure.
Early lease/freshness failures retain their original fault classification.
