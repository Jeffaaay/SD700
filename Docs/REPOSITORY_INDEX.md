...
|---|---|---|
| Current candidate | [README](../README.md), [RiseDiagnostic1 handoff](BuildToTarget2_RiseDiagnostic1/HANDOFF.md) | BuildToTarget2_RiseDiagnostic1; F10C/46530112/profile7; PHYSICAL_STATUS=NOT_RUN |
...
| Current software evidence | [RiseDiagnostic1 focused tests](BuildToTarget2_RiseDiagnostic1/HANDOFF.md) | Real host/build results; synthetic force inputs do not prove physical performance |
...
All34 pre-existing tracked HEX/ELF files keep their paths and hashes; [prior preservation inventory](RepositoryCleanup1/commit_a_firmware.json) pins those34. Pulse10msFix1 added two files; RiseDiagnostic1 adds the new current pair. All36 predecessors remain unchanged; total38. Historical firmware entries:
