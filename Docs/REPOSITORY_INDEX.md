...
|---|---|---|
| Current candidate | [README](../README.md), [Pulse10msFix1 handoff](BuildToTarget2_Pulse10msFix1/HANDOFF.md) | BuildToTarget2_Pulse10msFix1; F10C/46530111/profile7; PHYSICAL_STATUS=NOT_RUN |
...
| Current software evidence | [Pulse10msFix1 focused tests](BuildToTarget2_Pulse10msFix1/HANDOFF.md) | Real host/build results; synthetic force inputs do not prove physical performance |
...
All34 pre-existing tracked HEX/ELF files keep their paths and hashes; [prior preservation inventory](RepositoryCleanup1/commit_a_firmware.json) pins those34. The new current pair brings the total to36. Historical firmware entries:
