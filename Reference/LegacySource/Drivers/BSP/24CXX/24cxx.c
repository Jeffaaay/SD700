...
static void M24C02_gpio_init(void)
{
    GPIO_InitTypeDef gpio_init_struct;

    M24C02_WC_GPIO_CLK_ENABLE();

    gpio_init_struct.Pin = M24C02_WC_GPIO_PIN;
    gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;        /* 推挽输出 */
    gpio_init_struct.Pull = GPIO_NOPULL;                
    gpio_init_struct.Speed = GPIO_SPEED_FREQ_VERY_HIGH; /* 快速 */
    HAL_GPIO_Init(M24C02_WC_GPIO_PORT, &gpio_init_struct);/* 写使能 */
...
/**
 * @brief       在AT24CXX里面的指定地址开始写入指定个数的数据（目前使用的M24C02是16字节/页）
