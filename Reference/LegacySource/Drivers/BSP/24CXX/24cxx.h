...
#define M24C02_WC_GPIO_PORT             GPIOA
#define M24C02_WC_GPIO_PIN              GPIO_PIN_15
#define M24C02_WC_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */
#define WC(x)        do{ x ? \
                              HAL_GPIO_WritePin(M24C02_WC_GPIO_PORT, M24C02_WC_GPIO_PIN, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(M24C02_WC_GPIO_PORT, M24C02_WC_GPIO_PIN, GPIO_PIN_RESET); \
                          }while(0)       /* 写保护 */
