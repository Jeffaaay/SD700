...
$firmware=Join-Path $PSScriptRoot '../output/BuildToTarget2_Pulse10msFix1/firmware/SD700_ForceServo1_BuildToTarget2_Pulse10msFix1_RealBench_Release.hex'
